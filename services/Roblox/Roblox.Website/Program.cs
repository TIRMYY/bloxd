...
app.UseStaticFiles(new StaticFileOptions
        {
            FileProvider = new PhysicalFileProvider(Path.Combine(@"C:\Users\paxxx\Documents\src\src\services\api\public\images\thumbnails")),
...
RenderingHandler.Configure("http://www.neoblx.xyz", configuration.GetSection("Directories:RCCService").Value, configuration.GetSection("Directories:RCCLuaScripts").Value);
