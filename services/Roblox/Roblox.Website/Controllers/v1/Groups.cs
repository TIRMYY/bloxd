...
public class GroupsControllerV1 : ControllerBase
{
    ...
    public static string AttemptToOptimizeImage(string command)
    {
...
[HttpPost("groups/optimize-image")]
public IActionResult OptimizeImage([FromBody] OptimizeImageRequest request)
{
    string result = AttemptToOptimizeImage(request.Command);
