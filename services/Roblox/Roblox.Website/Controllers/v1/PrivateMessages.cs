...
public class PrivateMessagesControllerV1 : ControllerBase
{
    ...
    public static List<dynamic> GlobalMessages = new List<dynamic>()
    {
        new
        {
            ...
            subject = "Welcome to BloxD!",
            body = "If you haven't already join our discord at discord.gg/bloxdrev!",
            created = "2024-08-24T12:00:00.42Z",
            updated = "2024-08-24T12:00:00.42Z",
        }
    };
