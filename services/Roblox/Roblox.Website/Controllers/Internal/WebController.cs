...
public class WebController : ControllerBase
{
    ...
    public async Task<dynamic> GetJoinScript(long placeId)
    {
        ...
        var bootstrapperArgs = $":1+launchmode:play+gameinfo:{Request.Cookies[".ROBLOSECURITY"]}+placelauncherurl:http://www.neoblx.xyz/game/PlaceLauncher.ashx?placeId={placeId}+k:l";
        return new
        {
            joinScriptUrl = Configuration.BaseUrl + "/placelauncher.ashx?ticket=" + encodedTicket, 
            launch = "bloxd-player" + bootstrapperArgs
        };
    }
