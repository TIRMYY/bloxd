...
public class GroupsService : ServiceBase, IService
{
    ...
    private static readonly Regex RobloxGroupUrlRegex = new("https:\\/\\/(www\\.)?neoblx.xyz\\/groups\\/[0-9]+\\/[a-zA-Z\\-0-9]+", RegexOptions.IgnoreCase);
    
    private static readonly Regex RobloxGroupUrlRegexOld = new("https:\\/\\/(www\\.)?neoblx.xyz\\/my\\/groups\\.aspx\\?gid=[0-9]+", RegexOptions.IgnoreCase);
