...
const GamesSubPage = props => {
  ...
  return <div className='row'>
    ...
    <ActionButton className={buttonStyles.buyButton + ' w-auto ms-0'} label='Create New Game' onClick={() => window.location.href = 'https://www.neoblx.xyz/internal/create-place'} />
