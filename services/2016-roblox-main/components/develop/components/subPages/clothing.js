...
const detailsMap = {
  ...
  3: {
    ...
    subtext: `Audio uploads cost 175 Robux regardless of size, however this will change in the future. Audio uploads must be less than 7 minutes and smaller than 19.5 MB.`,
  },
  1: {
    name: 'Image',
    namePlural: 'images',
...
const Clothing = props => {
  ...
  const onSubmit = e => {
    ...
    if (image.size >= 8e+7) return setFeedback('The file is too large, fatass.');
